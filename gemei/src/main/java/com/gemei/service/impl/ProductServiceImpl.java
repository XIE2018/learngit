...
import com.gemei.dao.CategoryMapper;
...
import com.gemei.vo.ProductListVo;
...
public class ProductServiceImpl implements IProductService {
	...
	private ProductDetailVo assembleProductDetailVo(Product product){
		...
		//imageHost
		productDetailVo.setImageHost(PropertiesUtil.getProperty("ftp.server.http.prefix","http://47.92.235.208/"));
		//parentCategoryId
	...
	private ProductListVo assembleProductListVo(Product product){
		...
		//imageHost
		productListVo.setImageHost(PropertiesUtil.getProperty("ftp.server.http.prefix","http://47.92.235.208/"));
